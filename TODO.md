...
- [ ] **[LUPIN] Voice injection into idle CC sessions (tmux + UserPromptSubmit hook)** — Implement Phases 1-6 of the voice injection plan: tmux discovery in register_session.py, session lookup utilities, listener tmux Enter trigger, UserPromptSubmit hook, shell scripts, hook registration, tests (~24 unit + E2E).
