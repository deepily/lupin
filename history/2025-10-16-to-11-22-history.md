...
- **Docker Compose Configuration** (`docker-compose.yml`):
  ...
  - Database: `lupin_auth`, user: `lupin_dev`, password: `<redacted — see the untracked .env>`
