# Lupin History Archive: 2026-07-21 to 2026-07-27

> Archived 2026-08-04 by Mr. Radio 🦉 (session `7802a03f`) at the 19k CRITICAL threshold — history.md measured 18.9k tokens before the cut, and tonight's entry would have crossed it. Entries below are verbatim; nothing was summarised.
>
...
**Files**: `docker-compose.cloud-gpu.yml` · `src/cosa/utils/secret_drift.py` · `src/cosa/rest/multimodal_munger.py` · `src/cosa/rest/routers/speech.py` · `src/tests/unit/{test_secret_drift,test_munger_optional_contact_map,test_speech_stage_reporting}.py` · `src/rnd/v0.1.9/2026.07.22-vm-git-sync-strategy-decision.md` §7b · `TODO.md`
...
**Files**: `src/scripts/lupin-vm.sh`, `src/scripts/install-cosa-voice.sh`, `src/conf/claude-code-hooks.json`, `src/rnd/v0.1.9/2026.07.22-vm-git-sync-strategy-decision.md`.
