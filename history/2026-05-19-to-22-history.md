# Lupin Project History - May 19-22, 2026

> **Archive Period**: 2026-05-19 - 2026-05-22
> **Archived**: 2026-06-10
> **Reason**: history.md reached 23,684 tokens (94.7% of 25k limit — 🚨 CRITICAL); adaptive archival to restore the 8-12k retention target
> **Original Size**: 23,684 tokens → Main reduced to ~12,208 tokens (~11,476 tokens moved to this archive)
> **Parent Document**: [../history.md](../history.md)

This archive contains detailed session entries from May 19-22, 2026, a period of high-intensity development activity including the Multiplexer Phase 6c/7/7a authoring cascades, voice-persona pool expansion + per-repo preferred-persona env-var allocator, the heartbeat-poker abstraction + CJ Flow ingestion wiring, the `request_persona` MCP tool + compaction carry-forward fix, and the Recent-Activity filter-strip / Master-detail two-pane UI experiments.
...
- **[← Previous: 2026-05-16 to 05-18](2026-05-16-to-18-history.md)** — Model-server carve-out, Daily LoC Delta tool, doc-viewer scope unification, voice-persona stale-bridge fix

### Quick Context
This archive covers a **high-intensity** period with:
- ~13 sessions across 4 days (May 19-22, 2026)
- ~11,476 tokens of session detail
- Major themes: Multiplexer Phase 6c/7/7a authoring cascades (Nodes A-D, Runs 3-4), voice-persona pool expansion + per-repo preferred-persona allocator, heartbeat-poker abstraction + CJ Flow ingestion + TTS limiter fix, `request_persona` MCP tool + compaction carry-forward, Recent-Activity filter strip + Focus-bar chrono lock + Master-detail two-pane layout experiment, websocket-events.md doc fix
