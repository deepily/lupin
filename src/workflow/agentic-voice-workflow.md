...
2. **The retrain asymmetry.** A prompt line makes the command reachable *immediately*;
   ...
   (`src/rnd/v0.2.0/2026.08.15-router-emission-probe.md`). — 🔴 **REMOVED by `c752ab9e`** ("Delete useless detritus generated by overzealous cc agents", 2026-08-29); recover with `git show c752ab9e^:src/rnd/v0.2.0/2026.08.15-router-emission-probe.md`
