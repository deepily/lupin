...
//
// MEASURED, not argued (2026-09-23): swapping `filterStore` to the wrong store in THIS
// worktree's boot.ts left the pin at 4 passed / 0 failed. With the path fixed and the same
// break still planted it goes red. The green was never evidence the wiring was right.
