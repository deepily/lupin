...
>
> **Test coverage**: unit 3600 pass / 1 xfail / 0 fail (was 3549 Phase-0 baseline; +15 Phase-1 + +18 Phase-2 + +10 Phase-3 + 8 inline fixes for stale/shape). WebSocket smoke 50/50. Live API probes on `:7999` green for single-submit (Phase 2 fix validation) and queued for concurrent-happy-path (Phase 3).
>
