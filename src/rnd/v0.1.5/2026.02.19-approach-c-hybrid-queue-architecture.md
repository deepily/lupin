...
**Status**: SUPERSEDED — implementation planning moved to v0.1.7
...
>
> - **Design review** (post-v0.1.6 re-orientation): `00-design-review.md`
> - **Phase 1 design** (RLock + config + ApiResourceManager stub): `01-phase-1-rlock-config-and-resource-manager.md`
> - **Phase 2 design** (dispatcher + pool + pool-status endpoint): `02-phase-2-dispatcher-pool-and-pool-status.md`
> - **Phase 3 design** (ghost watchdog + ARM integration + E2E): `03-phase-3-ghost-watchdog-and-e2e.md`
