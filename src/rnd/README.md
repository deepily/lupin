...
|---------|--------|------:|--------:|-------|
| [v0.5.0](v0.5.0/) | ≤ 2025-07-10 | 7 | 1 | WebSocket TTS streaming, early notification design |
| [v0.6.0](v0.6.0/) | Jul 11 – Aug 1, 2025 | 11 | 0 | WebSocket user routing, progressive TTS, async bridge |
| [v0.7.0](v0.7.0/) | Aug 2 – Aug 15, 2025 | 12 | 0 | Fresh Queue UI, audio caching, smoke testing, job replay |
| [v0.8.0](v0.8.0/) | Aug 16 – Sep 27, 2025 | 5 | 1 | LanceDB migration, three-level question architecture |
| [v0.9.0](v0.9.0/) | Sep 28 – Oct 7, 2025 | 7 | 1 | JWT/OAuth auth system, admin user management |
...
| [v0.1.6](v0.1.6/) | Mar 12 – present | 17 | 2 | CJ Flow persistence, timed execution + monopolize + pause, presentation generator, test isolation, bug fix expediter |
