...
- The directory name `lupin` must remain unchanged due to external dependencies
...
## Constraints
1. **DO NOT** change the directory name `lupin`
2. **DO NOT** modify any file paths containing `lupin`
...
- Directory structure (especially `lupin` directory)
