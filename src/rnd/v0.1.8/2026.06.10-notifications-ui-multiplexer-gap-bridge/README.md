...
| # | Doc | What it answers |
|---|---|---|
| 00 | [Functional-change summary](00-functional-change-summary.md) | Every user-facing capability added to the JS notifications client since the anchor, grouped into 12 features (F1–F12), with commit refs, front-end surfaces, server deps, and E2E tests. | *[referenced file removed in the 2026-09-22 R&D cleanup, ticket `3a2f726b`; recover with `git log --diff-filter=D -- <path>` then `git show <sha>^:<path>`]*
