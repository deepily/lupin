...
|---|---|---|
| T7 — new "#0 shared row controls" | **LANDED** | §Stage-2 treatments, T7 row: registered as A-2 #0, built once in `templates/taskRowControls.ts`, lands before #7/#8/#9 |
| T8 — split #2's card chrome (R14) | **LANDED** | the decomposition line 2a–2m; **2m** is card chrome R14. The ⚠️ on the #2 cell stays |
| C5 — legacy's suite green | **LANDED** | C5 row: per-item legacy run for any item editing `notifications.js`/`.html` |
