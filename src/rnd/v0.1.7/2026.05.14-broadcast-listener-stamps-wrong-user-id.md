...
| **Status** | 🟢 **Option C COMPLETE — CoSA-side filter shipped 2026-05-14; Lupin-side writer-side stamper shipped 2026-05-17 by Arnold 🪨 (session `9ba9a34a`). See [companion plan](2026.05.17-owner-user-id-stamper-writer-side/01-design.md) for design + §6 root-cause find + Fix B carry-forward + 22 unit tests + 5/5 `:8000` integration green.** |
