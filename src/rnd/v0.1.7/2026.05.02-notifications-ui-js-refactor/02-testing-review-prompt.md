# Testing Review Prompt (first-pass gate before Phase 1 implementation)

**When to use**: After a fresh context clear, before any code is written. This is the FIRST of two review passes (the second is `03-fitness-review-prompt.md`). Paste the code block below as your opening message to Claude Code.
...
**Expected outputs**:- A findings table with File / Line / Problem / Proposed fix rows
...
```
We are resuming work on the 2026.05.02-notifications-ui-js-refactor milestone on branch
...
2. src/rnd/v0.1.7/2026.05.02-notifications-ui-js-refactor/00-working-contract.md
3. src/rnd/v0.1.7/2026.05.02-notifications-ui-js-refactor/01-design-review.md
4. src/rnd/v0.1.7/2026.05.02-notifications-ui-js-refactor/02-phase-1-rlock-config-and-resource-manager.md
5. src/rnd/v0.1.7/2026.05.02-notifications-ui-js-refactor/03-phase-2-dispatcher-pool-and-pool-status.md
6. src/rnd/v0.1.7/2026.05.02-notifications-ui-js-refactor/04-phase-3-ghost-watchdog-and-e2e.md
7. src/rnd/v0.1.7/2026.05.02-notifications-ui-js-refactor/90-phase-1-execution-log.md
8. src/rnd/v0.1.7/2026.05.02-notifications-ui-js-refactor/91-phase-2-execution-log.md
9. src/rnd/v0.1.7/2026.05.02-notifications-ui-js-refactor/92-phase-3-execution-log.md
...
in your findings:
    ...
    grep -rn "Manual\|manual" src/rnd/v0.1.7/2026.05.02-notifications-ui-js-refactor/
    grep -rn "EXECUTOR: HUMAN" src/rnd/v0.1.7/2026.05.02-notifications-ui-js-refactor/
    grep -rnE "^\- \[ \] [^E]" src/rnd/v0.1.7/2026.05.02-notifications-ui-js-refactor/
