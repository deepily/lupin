...
| **Networking (VPC/DNS/PGA)** | Cloud DNS private zone `run.app` + PGA routes + **Docker-bridge MTU 1460 fix persisted in VM compose** — proven by live app→model-server 200 that survived a full recreate (2026-07-08; `src/rnd/v0.1.9/2026.07.08-cpu-vm-app-restore-runbook.md`) | ✅ | Nothing |
