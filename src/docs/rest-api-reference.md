...
| GET | `/api/proxy/pending/{user_email}` | Admin | Get pending decisions |
| POST | `/api/proxy/ratify/{decision_id}` | Admin | Approve or reject decision |
| DELETE | `/api/proxy/decision/{decision_id}` | Admin | Hard-delete decision |
