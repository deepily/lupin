...
output "lancedb_bucket_name" {
  value       = local.lancedb_bucket
  description = "LanceDB bucket name (composed; matches lupin-app.ini)."
}
...
output "bucket_names" {
  value       = [local.lancedb_bucket, local.deep_research_bucket]
