# Post-Game Retrospective for Lupin Project
...
This slash command is a **reference wrapper** that reads the canonical workflow (`workflow/post-game.md`) on every invocation. The canonical doc is project-agnostic; this wrapper injects PIP-specific paths + the [LUPIN] prefix. Other projects use their own thin wrappers.
